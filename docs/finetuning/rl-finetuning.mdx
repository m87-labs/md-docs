...
For point and detect skills, you can optionally provide ground truth coordinates, and the system will compute rewards automatically.
...
- **End-to-end tutorial** — Walk through a complete finetuning workflow
