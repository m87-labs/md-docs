...
See the [HTTP API reference](/finetuning/http-api-reference#using-finetuned-models-for-inference) for full details on using finetuned models for inference.
